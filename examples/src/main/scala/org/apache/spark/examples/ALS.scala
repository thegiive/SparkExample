 ...
 */
private[examples] case class OutLinkBlock(elementIds: Array[Int], shouldSend: Array[BitSet])
 ...
 */
private[examples] case class InLinkBlock(
  ...
  extends Serializable with Logging
{
  ...
  : Array[Array[Double]] =
  {
    ...
    logError(numUsers.toString()+" "+rank.toString());
